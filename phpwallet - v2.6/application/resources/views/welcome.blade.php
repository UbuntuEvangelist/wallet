        ...
        <section class="navigation">
            <header>
                <div class="header-content">
                    <div class="logo"><a href="{{url('/')}}"><img src="{{asset('landing/img/infinio-logo.png')}}" alt="infinio logo"></a></div>
                    <div class="header-nav">
                        <nav>
                            ...
                            <ul class="member-actions">
                                    @if (Auth::check())
                                        <li><a href="{{ route('logout') }}" class="login" onclick="event.preventDefault();
                                    ...
                                    @else
                                        <li><a href="{{ url('/register') }}" class="login">{{__('Register')}}</a></li>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="hero-content text-center">
                        <h1>PHPWALLET, the smart choice for your business.</h1>
                        ...
                        <p class="intro">Pay in a snap with the easy and elegant interface which gives you an outstanding experience.<br>
                            ...
                            @if (Auth::check())
                                <a href="{{url('/')}}/home" class="btn btn-fill btn-large btn-margin-right">dashboard</a>
                            @else
                               <a href="{{url('/')}}/login" class="btn btn-large btn-margin-right">Get Started</a>
                            @endif
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-4 intro-feature">
                    ...
                    <div class="intro-content last">
                        ...
                        <p>Payments you receive go to your PHPWALLET Balance in moments, and you can withdraw funds to your bank account.</p>
                    </div>
                </div>
                <div class="col-md-4 intro-feature">
                    <div class="intro-icon">
            ...
            <div class="row">
                <div class="col-md-5 col-md-offset-7">
                    <div class="feature-list">
                        <h3>PHPWALLET will drive your product forward</h3>
                        ...
                        <ul class="features-stack">
                            <li class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>PHPWALLET is universal and will look smashing on any device.</p>
                                </div>
                            </li>
                            <li class="feature-item">
                                <div class="feature-icon">
                                ...
                                <div class="feature-content">
                                    <h5>User Design</h5>
                                    <p>PHPWALLET takes advantage of common design patterns, allowing for a seamless experience for users of all levels.</p>
                                </div>
                            </li>
                            <li class="feature-item">
                                <div class="feature-icon">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>Download and re-use the PHPWALLET open source code for any other project you like.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="footer-links">
                        ...
                        <p>Copyright © 2018 <a href="#">PHPWALLET</a></p>
                    </div>
                </div>
                <div class="social-share">
                    <p>Share PHPWALLET with your friends</p>
