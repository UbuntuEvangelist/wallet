...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-9 " >
          ...
          <div class="card" >
            <div class="header">
                <h2><strong><?php echo e(__('Deposit Money')); ?></strong></h2>
            ...
            <div class="body">
              <form action="<?php echo e(route('post.credit')); ?>" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="row mb-5">
                      <div class="col-lg-12 ">
                          <label for=""><?php echo e(__('How to proceed with')); ?> <?php echo e($current_method->name); ?> <?php echo e(__('deposits')); ?> </label>
                    ...
                    <div class="row mb-5">
                      <div class="col">
                        <div class="form-group <?php echo e($errors->has('message') ? ' has-error' : ''); ?>">
                          ...
                          <textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="<?php echo e(__('Message to the reviewer')); ?>"></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix"></div>
