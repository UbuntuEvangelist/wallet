        ...
        <div class="col-md-9 ">
          ...
          <div class="body">
            <form action="<?php echo e(route('post.withdrawal')); ?>" method="post" enctype="multipart/form-data" id="withdrawal_form">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group <?php echo e($errors->has('platform_id') ? ' has-error' : ''); ?>">
                   <label for="platform_id"><?php echo e($current_method->name); ?> ID  </label>
              ...
              <div class="row">
                <div class="col-lg-12">
                    <label for=""><?php echo e(__('About')); ?> <?php echo e($current_method->name); ?> <?php echo e(__('withdrawals')); ?> </label>
