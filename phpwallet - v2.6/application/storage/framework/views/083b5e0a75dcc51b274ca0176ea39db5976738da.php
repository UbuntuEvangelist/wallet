    ...
    <div class="body">
		...
		<h5><strong>Step 1:</strong></h5>
	   	<div class="alert alert-info mb-5">
	   		<p>Send a CURL POST request that contains <strong>'merchant_key'</strong>, <strong>'invoice'</strong>, and <strong>'currency_code'</strong> variables to  <kbd><?php echo e(url('/')); ?>/purchase/link</kbd>
	   		</p> 
