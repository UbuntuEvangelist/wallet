              ...
              <div class="table-responsive">
                  <table class="table m-b-0">
                      ...
                      <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                          <td><?php echo e($transaction->id); ?><br>
                            <?php if($transaction->transactionable_type == "App\Models\Sale" or $transaction->transactionable_type == "App\Models\Purchase"): ?>
                            <a href="<?php echo e(url('/')); ?>/transaction/<?php echo e($transaction->id); ?>" class="button"><span class=" ml-0 mr-0"><?php echo e(__('invoice')); ?></span></a>
                            <?php endif; ?>
                          </td>
