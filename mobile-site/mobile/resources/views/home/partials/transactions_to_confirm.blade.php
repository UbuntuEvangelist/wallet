      ...
      <ion-grid style="border-bottom: 1px solid #ddd;" >
       <ion-row padding>
         ...
         <ion-col>
          ...
          {{csrf_field()}}
          <input type="hidden" name="tid" value="{{$transaction->id}}">
          <ion-button color="light" expand="full" mode="ios" size="small" type="submit"><ion-icon name="close" color="danger" slot="start"></ion-icon>{{__('Delete Transaction')}}</ion-button>
          </form>
         </ion-col>
       </ion-row>
      </ion-grid>
