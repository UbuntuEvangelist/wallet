            ...
            <div class="body">
                ...
                <div class="row">
                    <div class="preview col-lg-4 col-md-12">
                        <div class="preview-pic tab-content">
                            <div class="tab-pane active show" id="product_1">
                            	<img src="<?php echo e(url('/')); ?>/storage/wuP1CGaRgPMQKgwn1vtV3wZJLSoCbkhQyVchgwnS.png" class="img-fluid">
                            </div>
                    ...
                    <div class="details col-lg-8 col-md-12" id="buy_form">
                        <h3 class="product-title m-b-0"><?php echo e(__('Get Vouchers codes and Load your wallet, Use your Credit Card or PayPal')); ?></h3>
                        <h4 class="price m-t-0">Price: <span class="text-success">${{total}}</span></h4>
                        
                        
                        <div class="action">
                          <form class="d-flex justify-content-left" method="post" action="<?php echo e(route('buyvoucher')); ?>">
                          	<div class="row mb-5">
		                      <div class="col-lg-12">
		                        <div class="form-group ">
		                          	<label for="message"><?php echo e(__('Quantity')); ?></label>
...
<?php $__env->startSection('js'); ?>
    <?php echo $__env->make('vouchers.buyvue', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
