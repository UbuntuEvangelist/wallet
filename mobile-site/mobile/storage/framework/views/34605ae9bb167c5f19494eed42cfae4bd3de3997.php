            ...
            <div class="col-12">
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="<?php echo e((Route::is('exchange.form') ? 'active open' : '')); ?>"> 
                            <a href="<?php echo e(url('/')); ?>/exchange/first/0/second/0"><i class="icon-refresh"></i><span><?php echo e(__('Exchange')); ?></span></a>
                        </li>
