                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $transactions_to_confirm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <input type="submit"  class="btn btn-success btn-sm pull-left" value="confirm">
                              </form>
                            ...
                            <td>
                              ...
                              <input type="hidden" name="tid" value="<?php echo e($transaction->id); ?>">
                              <input type="submit"  class="btn btn-danger btn-sm pull-right" value="Delete Transaction">
                              </form>
                            </td>
                            ...
                            <td><?php echo $__env->make('home.partials.name', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></a></td>
